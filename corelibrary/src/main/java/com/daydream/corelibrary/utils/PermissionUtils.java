...
public class PermissionUtils {
    ...
    public static boolean getLocationPermissions(@NonNull Activity activity, int requestCode) {
        return requestPermissions(activity, requestCode, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION);
    }
    /**
     * 获取读取联系人权限
     *
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getInstallPermissions(@NonNull Activity activity, int requestCode) {
        return requestPermissions(activity, requestCode, Manifest.permission.REQUEST_INSTALL_PACKAGES);
    }
