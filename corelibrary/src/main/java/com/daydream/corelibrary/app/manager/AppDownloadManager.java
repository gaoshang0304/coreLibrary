package com.daydream.corelibrary.app.manager;
...
public class AppDownloadManager {
    ...
    public void downloadApk(String apkUrl, String title, String desc) {
        ...
        File apkFile = new File(weakReference.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "hogolife_homanager.apk");
        ...
        request.setDestinationInExternalFilesDir(weakReference.get(), Environment.DIRECTORY_DOWNLOADS, "hogolife_homanager.apk");
        ...
        if (completeDownLoadId == mReqId) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) { // 6.0以下
                ...
                uri = FileProvider.getUriForFile(context,
                        "com.hogolife.homanager.FileProvider",
                        new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "hogolife_homanager.apk"));
