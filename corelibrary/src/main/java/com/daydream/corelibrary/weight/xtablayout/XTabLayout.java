package com.daydream.corelibrary.weight.xtablayout;
...
public class XTabLayout extends HorizontalScrollView {
    ...
    private final float xTabIndicatorRadius;
    //文本字母是否小写转大写
    ...
    public XTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        xTabIndicatorRadius = a.getFloat(R.styleable.XTabLayout_xTabIndicatorRadius, 5f);
        ...
        public void draw(Canvas canvas) {
            ...
            if (mIndicatorLeft >= 0 && mIndicatorRight > mIndicatorLeft) {
               ...
               /* int maxWidth = mIndicatorRight - mIndicatorLeft;
                ...
                //画圆角矩形指示器
                RectF rectF = new RectF(mIndicatorLeft, getHeight() - mSelectedIndicatorHeight,
                        mIndicatorRight, getHeight());
                canvas.drawRoundRect(rectF, xTabIndicatorRadius, xTabIndicatorRadius, mSelectedIndicatorPaint);
            }
        }
    }
