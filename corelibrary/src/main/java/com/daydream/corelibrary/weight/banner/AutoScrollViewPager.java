...
//    private int mDuration = DURATION_DEFAULT;
     ...
     * 自动滚动的Handler信息 *
     */
    private AutoScrollHandler mHandler = new AutoScrollHandler(AutoScrollViewPager.this);
    ...
    protected void onAttachedToWindow() {
        ...
        if(mHandler != null){
            requestLayout();    // 手动调用requestLayout方法修改mFirstLayout属性为false

            mHandler.setViewPager(this);
...
//    }
    ...
    public void startAutoScroll() {
        mHandler.setViewPager(AutoScrollViewPager.this);
...
*/
    ...
    private static class AutoScrollHandler extends Handler {
        ...
        AutoScrollHandler(AutoScrollViewPager pager) {
            this.viewPager = pager;
        }

        void setViewPager(AutoScrollViewPager viewPager){
